#ifndef OV_CORE_TRACK_GCN_H
#define OV_CORE_TRACK_GCN_H
 ...
 */
class TrackGCN : public TrackBase
{
...
public:
     ...
     */
    TrackGCN(std::map<size_t,Eigen::Matrix3d> camera_k,
     ...
     */
    explicit TrackGCN(std::map<size_t,Eigen::Matrix3d> camera_k,
                                std::map<size_t,Eigen::Matrix<double,4,1>> camera_d,
                                std::map<size_t,bool> camera_fisheye,
